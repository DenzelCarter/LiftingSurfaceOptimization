...
TARGET_COL = 'prop_efficiency' # <-- UPDATED to our new target
...
features = [AR_COL, LAMBDA_COL, AOAROOT_COL, AOATIP_COL, RPM_COL, MOD_COL, THICK_COL, REYN_COL, CT_COL]
...
plt.xlabel("Actual Prop Efficiency")
plt.ylabel("Predicted Prop Efficiency")
plt.title(f"Predicted vs. Actual Prop Efficiency (R² = {r2:.3f})")
